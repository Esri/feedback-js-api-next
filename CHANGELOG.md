...
- BUG-000171015: Fixed an issue where calling [VectorTileLayer.setStyleLayer()](/api-reference/esri-layers-VectorTileLayer.html#setStyleLayer) from the [MapView.hitTest()](/api-reference/esri-views-MapView.html#hitTest) resulted in an error.
