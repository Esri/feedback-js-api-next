...
- [Esri Community - 1277457](https://community.esri.com/t5/arcgis-javascript-maps-sdk-questions/old-tiles-remain-drawn-with-client-side-rendering/m-p/1277457): Improved the behavior of [BaseTileLayer]([/api-reference/esri-layers-BaseTileLayer.html](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-BaseTileLayer.html)) to release the tiles that are no longer displayed.
