...
* [Esri Community - 1282644](https://community.esri.com/t5/arcgis-javascript-maps-sdk-questions/how-to-make-the-previewhtml-same-as-the-text/m-p/1282644): Fixed an issue where the background and halo of a TextSymbol or CIMSymbol would would not render in the symbol preview returned from `symbolUtils.renderPreviewHTML()`.
