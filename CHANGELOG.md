...
* [Esri Community - 1278156](https://community.esri.com/t5/arcgis-javascript-maps-sdk-questions/bug-4-26-simplelinesymbol-is-drawn-despite-setting/m-p/1278156): Fixed an issue where the [SimpleLineSymbol]([/api-reference/](https://developers.arcgis.com/javascript/latest/api-reference/esri-symbols-SimpleLineSymbol.html) is drawn despite setting the [style]([/api-reference/](https://developers.arcgis.com/javascript/latest/api-reference/esri-symbols-SimpleLineSymbol.html#style) to `none`.
